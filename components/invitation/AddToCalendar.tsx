  ...
  return (
    <div className="relative">
      <motion.button
        ...
        className="inline-flex w-full items-center justify-center rounded-full bg-ink px-6 py-3 text-xs font-medium uppercase tracking-[0.2em] text-stone shadow-[0_10px_24px_rgba(63,52,44,0.16)] transition-colors hover:bg-gold-deep"
      >
        Tambah ke kalendar
      </motion.button>
